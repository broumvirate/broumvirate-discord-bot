...
module.exports.help = '**&vote [yes/no] [tweet id]:** Vote for a tweet in the running.'
    ...
    tweetindex.exists({
        ...
        if (err) {
            ...
            if (result) {
                ...
                if (args[0] == 'yes') {
                    currenttweet.yes++;
                    message.reply(`you voted yes for the tweet '${currenttweet.content}'.`);
                }
                if (args[0] == 'no') {
                    currenttweet.no++
                    message.reply(`you voted no for the tweet '${currenttweet.content}'.`);
                }
